...
<body>
   ...
   <section class="add-products">
      ...
      <form action="" method="POST" enctype="multipart/form-data">
         ...
         <input type="number" min="0" class="box" required placeholder="Giá sản phẩm" name="price">
      ...
      <div class="box-container">
         ...
         ?>
               <div class="box">
                  ...
                  <a href="admin_product.php?delete=<?php echo $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('Xóa sản phẩm?');">Xóa</a>
               </div>
         <?php
            }
         } else {
