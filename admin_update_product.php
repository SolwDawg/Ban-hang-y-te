...
<body>
    ...
    <section class="update-products">
        ...
        $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE id = '$update_id'") or die('query died');
